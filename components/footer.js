      ...
      <footer className='text-gray-600 body-font'>
        <div className='container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col'>
          ...
          <span className='inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start items-center'>
            <Link className='ml-3 text-gray-500 ' href='https://github.com/mickck' target='_blank'>
              <svg width='24px' height='24px' viewBox='0 0 1024 1024' xmlns='http://www.w3.org/2000/svg' class='icon' fill='currentColor'>
